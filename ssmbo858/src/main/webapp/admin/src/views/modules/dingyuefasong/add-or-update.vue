<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="订阅编号" prop="dingyuebianhao">
          <el-input v-model="ruleForm.dingyuebianhao" 
              placeholder="订阅编号" clearable  :readonly="ro.dingyuebianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="订阅编号" prop="dingyuebianhao">
              <el-input v-model="ruleForm.dingyuebianhao" 
                placeholder="订阅编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报刊名称" prop="baokanmingcheng">
          <el-input v-model="ruleForm.baokanmingcheng" 
              placeholder="报刊名称" clearable  :readonly="ro.baokanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报刊名称" prop="baokanmingcheng">
              <el-input v-model="ruleForm.baokanmingcheng" 
                placeholder="报刊名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报刊类型" prop="baokanleixing">
          <el-input v-model="ruleForm.baokanleixing" 
              placeholder="报刊类型" clearable  :readonly="ro.baokanleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报刊类型" prop="baokanleixing">
              <el-input v-model="ruleForm.baokanleixing" 
                placeholder="报刊类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报刊日期" prop="baokanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.baokanriqi" 
                type="date"
                :readonly="ro.baokanriqi"
                placeholder="报刊日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baokanriqi" label="报刊日期" prop="baokanriqi">
              <el-input v-model="ruleForm.baokanriqi" 
                placeholder="报刊日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报刊内容" prop="baokanneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.baokanneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baokanneirong" label="报刊内容" prop="baokanneirong">
                    <span v-html="ruleForm.baokanneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.baokanneirong = this.ruleForm.baokanneirong.replace(reg,'../../../ssmbo858/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dingyuefasong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dingyuefasongCrossAddOrUpdateFlag = false;
						 this.parent.search();
